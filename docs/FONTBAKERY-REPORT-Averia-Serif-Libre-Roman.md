...
* :bread: **PASS** /Users/Air/Google/fonts/ofl/averiaseriflibre/DESCRIPTION.en_us.html is a propper HTML file.
...
<details>
<summary><b>[113] Averia-Serif-Libre-Roman-VF.ttf</b></summary>
<details>
...
* :fire: **FAIL** OS/2.usWinAscent value should be equal or greater than 1890, but got 1823 instead [code: ascent]
...
* :fire: **FAIL** Whitespace glyphs missing for the following codepoints: 0x00A0.
...
* :warning: **WARN** OS/2 VendorID is 'PfEd', a font editor default. You should set it to your own 4 character code, and register that code with Microsoft at https://www.microsoft.com/typography/links/vendorlist.aspx [code: bad]
...
* :warning: **WARN** Name table entry ("Copyright (c) 2011, Dan Sayers (i@iotic.com), with Reserved Font Name 'Averia' and 'Averia Libre'.") contains "Reserved Font Name". This is an error except in a few specific rare cases.
...
* :zzz: **SKIP** Unfulfilled Conditions: not missing_whitespace_chars
...
<details>
<summary>:zzz: <b>SKIP:</b> Whitespace and non-breaking space have the same width?</summary>
...
* :information_source: **INFO** Version string is: "Version 2.000; ttfautohint (v1.8.2) -l 8 -r 50 -G 200 -x 14 -D latn -f none -a sss -W -X """
...
* :information_source: **INFO** This font contains the following optional tables [loca, cvt , fpgm, prep, gasp, DSIG, GPOS]
...
* :bread: **PASS** Font has ttfautohint params (-l 8 -r 50 -G 200 -x 14 -D latn -f none -a sss -W -X "")
